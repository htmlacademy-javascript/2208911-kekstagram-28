...
const COMMENT_SYMBOLS_MAX_COUNT = 140;
...
export {COMMENTS_PART, HASHTAGS_MAX_COUNT, COMMENT_SYMBOLS_MAX_COUNT, VALID_SYMBOLS,
  SCALE_IMG_STEP, SCALE_IMG_MAX, SCALE_IMG_MIN, EFFECT, RENDER_DELAY,
  ALERT_SHOW_TIME, COUNT_RANDOM_PHOTO, TYPES};
